...
contract SkyRocketBattle is ERC1155Holder, AccessControl {
    ...
    **/
    ...
    /**
    * @dev Get total won battles
    **/
    function getTotalWonBattles() public view returns (uint256 _totalWonBattles) {
        return totalWonBattles;
    }

    /**
    * @dev Get the battle details
    **/
